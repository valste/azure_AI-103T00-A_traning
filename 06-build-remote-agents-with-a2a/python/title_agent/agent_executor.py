...
The AgentExecutor class implementation must contain the methods execute and cancel.
The cancel method has been provided for you. The execute method includes
a TaskUpdater object that manages events and signals to the caller when the task is complete.
"""
